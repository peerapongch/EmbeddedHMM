...
source('../../samplers/model1_lambda_param_RW_3.R')
N <- 9000
L <- 80
N.mcmc.param <- 20
seed <- 1 
rw_scale <- c(0.1,0.1,0.1,0.1)
checkpoint.name <- './data/checkpoint_poisson1_3v1.RData'
system.time(
...
save(lambda_out,file='./data/poisson1_lambda_param_3_v1.RData')
