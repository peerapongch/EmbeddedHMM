...
param_update_rw <- function(param_current,param_formed_current,param_lprob_current,X_current,Y,rw_scale,dim){
  ...
  param_new[1:2] <- param_current[1:2] + rw_scale[1:2]*rnorm(2)
  # print('param updates 1')
  # print(param_current)
  # print(param_new)
  ...
  param_new <- param_current
  param_new[3] <- param_new[3] + rw_scale[3]*rnorm(1) 
  # print('param updates 2')
  # print(param_current)
  # print(param_new)
...
lambdaModel2_param4 <- function(ssm,N,L,N.mcmc.param=20,init=NULL,seed=NULL,rw_scale=c(0.5,0.5,0.5),rho.init=NULL,phi.init=NULL,delta.init=NULL,checkpoint.name=NULL){
  ...
  param_formed_current <- list(F=F,sigma_init=sigma_init,sigma=sigma,sigma_init_inv=sigma_init_inv,sigma_inv=sigma_inv,delta=delta.init)
