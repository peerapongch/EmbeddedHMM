...
lambdaModel1_param <- function(ssm,N,L,init=NULL,seed=NULL,N.mcmc.param=20,rw_scale=c(0.1,0.1,0.1,0.1),rho.init=NULL,phi.init=NULL,delta.init=NULL,c.init=NULL,checkpoint.name=NULL){
