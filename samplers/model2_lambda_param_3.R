...
lambdaModel2_param <- function(ssm,N,L,N.mcmc.param=20,init=NULL,seed=NULL,rw_scale=c(0.5,0.5,0.5),rho.init=NULL,phi.init=NULL,delta.init=NULL,checkpoint.name=NULL){
  ...
  param_formed_current <- list(F=F,sigma_init=sigma_init,sigma=sigma,sigma_init_inv=sigma_init_inv,sigma_inv=sigma_inv, sigma_init_U=sigma_init_U, sigma_init_L=sigma_init_L, sigma_U=sigma_U, sigma_L=sigma_L, delta=delta)
